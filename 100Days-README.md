...
0.  Check out [the Official Site](http://100daysofx.com/) for the #100DaysOfX movement. Connect with others on the same challenge from this list: www.100DaysOfX.com/connect
...
1.  **Create a plan for improving your health**
1.  **Work on an item from the plan EVERY DAY for the next 100 days.**
...
1.  **Tweet your progress every day using the #100DaysOfX hashtag.**
